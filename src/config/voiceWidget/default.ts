...
export function toConfigurationRecord(config: VoiceWidgetConfig): WidgetConfigurationRecord {
  ...
  return {
    ...
    branding: {
      ...
      startLabel: config.branding?.startLabel ?? '',
      connectingLabel: config.branding?.connectingLabel ?? '',
      connectedLabel: config.branding?.connectedLabel ?? '',
      endLabel: config.branding?.endLabel ?? '',
      retryLabel: config.branding?.retryLabel ?? '',
      muteLabel: config.branding?.muteLabel ?? '',
      unmuteLabel: config.branding?.unmuteLabel ?? '',
      errorMessage: config.branding?.errorMessage ?? '',
      callEndedMessage: config.branding?.callEndedMessage ?? '',
    ...
    call: {
      ...
      initialSilenceTimeoutSeconds: config.behavior?.initialSilenceTimeoutSeconds ?? 60,
    },
    chat: {
    ...
    behavior: {
      ...
      allowAgentNavigation: config.behavior?.allowAgentNavigation !== false,
...
export function fromConfigurationRecord(record: WidgetConfigurationRecord): VoiceWidgetConfig {
  ...
  return {
    ...
    branding: {
      ...
      title: brandingRecord.title ?? defaultVoiceWidgetConfig.branding.title,
      subtitle: brandingRecord.subtitle ?? defaultVoiceWidgetConfig.branding.subtitle,
      welcomeMessage: brandingRecord.welcomeMessage ?? defaultVoiceWidgetConfig.branding.welcomeMessage,
      startLabel: brandingRecord.startLabel ?? defaultVoiceWidgetConfig.branding.startLabel,
      connectingLabel: brandingRecord.connectingLabel ?? defaultVoiceWidgetConfig.branding.connectingLabel,
      connectedLabel: brandingRecord.connectedLabel ?? defaultVoiceWidgetConfig.branding.connectedLabel,
      endLabel: brandingRecord.endLabel ?? defaultVoiceWidgetConfig.branding.endLabel,
      retryLabel: brandingRecord.retryLabel ?? defaultVoiceWidgetConfig.branding.retryLabel,
      muteLabel: brandingRecord.muteLabel ?? defaultVoiceWidgetConfig.branding.muteLabel,
      unmuteLabel: brandingRecord.unmuteLabel ?? defaultVoiceWidgetConfig.branding.unmuteLabel,
      errorMessage: brandingRecord.errorMessage ?? defaultVoiceWidgetConfig.branding.errorMessage,
      callEndedMessage: brandingRecord.callEndedMessage ?? defaultVoiceWidgetConfig.branding.callEndedMessage,
      placeholderText: brandingRecord.placeholderText ?? record.chat?.placeholderText ?? defaultVoiceWidgetConfig.branding.placeholderText,
      agentMessageName: brandingRecord.agentMessageName ?? record.chat?.agentMessageName ?? defaultVoiceWidgetConfig.branding.agentMessageName,
    ...
    theme: deepMerge(defaultVoiceWidgetConfig.theme, record.theme || {}),
    ...
    behavior: {
      ...
      showEndButton: record.behavior?.showEndButton ?? defaultVoiceWidgetConfig.behavior.showEndButton,
      showAgentStatus: record.behavior?.showAgentStatus ?? defaultVoiceWidgetConfig.behavior.showAgentStatus,
      showDuration: record.behavior?.showDuration ?? defaultVoiceWidgetConfig.behavior.showDuration,
      showWaveform: record.behavior?.showWaveform ?? defaultVoiceWidgetConfig.behavior.showWaveform,
      allowAgentNavigation: record.behavior?.allowAgentNavigation ?? defaultVoiceWidgetConfig.behavior.allowAgentNavigation ?? true,
      allowTextChat: record.chat?.allowTextChat ?? record.behavior?.allowTextChat ?? defaultVoiceWidgetConfig.behavior.allowTextChat,
      allowVoiceChat: record.call?.allowVoiceChat ?? record.behavior?.allowVoiceChat ?? defaultVoiceWidgetConfig.behavior.allowVoiceChat,
      defaultTab: record.chat?.defaultTab ?? record.behavior?.defaultTab ?? defaultVoiceWidgetConfig.behavior.defaultTab,
      autoResetEndedTimeout: record.call?.autoResetEndedTimeout ?? record.behavior?.autoResetEndedTimeout ?? defaultVoiceWidgetConfig.behavior.autoResetEndedTimeout,
      connectionTimeout: record.call?.connectionTimeout ?? record.behavior?.connectionTimeout ?? defaultVoiceWidgetConfig.behavior.connectionTimeout,
      telemetryEnabled: record.behavior?.telemetryEnabled ?? defaultVoiceWidgetConfig.behavior.telemetryEnabled,
      installationType: record.behavior?.installationType ?? defaultVoiceWidgetConfig.behavior.installationType ?? 'javascript',
      maxCallDurationMinutes: (record.behavior as any)?.maxCallDurationMinutes ?? (record.call as any)?.maxCallDurationMinutes ?? defaultVoiceWidgetConfig.behavior.maxCallDurationMinutes ?? 10,
      maxChatTurns: (record.behavior as any)?.maxChatTurns ?? (record.chat as any)?.maxChatTurns ?? defaultVoiceWidgetConfig.behavior.maxChatTurns ?? 30,
      initialSilenceTimeoutSeconds: (record.behavior as any)?.initialSilenceTimeoutSeconds ?? (record.call as any)?.initialSilenceTimeoutSeconds ?? defaultVoiceWidgetConfig.behavior.initialSilenceTimeoutSeconds ?? 60,
      maxDailyCalls: (record.behavior as any)?.maxDailyCalls ?? defaultVoiceWidgetConfig.behavior.maxDailyCalls ?? 100,
      maxDailyChats: (record.behavior as any)?.maxDailyChats ?? defaultVoiceWidgetConfig.behavior.maxDailyChats ?? 500,
      chatRateLimitPerMinute: (record.behavior as any)?.chatRateLimitPerMinute ?? defaultVoiceWidgetConfig.behavior.chatRateLimitPerMinute ?? 15,
