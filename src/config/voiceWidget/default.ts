...
export function fromConfigurationRecord(record: WidgetConfigurationRecord): VoiceWidgetConfig {
  ...
  return {
    ...
    behavior: {
      ...
      initialSilenceTimeoutSeconds: (record.behavior as any)?.initialSilenceTimeoutSeconds ?? (record.call as any)?.initialSilenceTimeoutSeconds ?? defaultVoiceWidgetConfig.behavior.initialSilenceTimeoutSeconds ?? 15,
